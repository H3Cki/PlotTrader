...
func NewClient(creds Credentials) *SpotClient {
	return &SpotClient{
		sdkClient: binanceSDK.NewClient(creds.API_KEY, creds.SECRET_KEY),
	}
}

func (e *SpotClient) Name() string {
	return "binance"
}

func (e *SpotClient) OrderPending(orderID any) (bool, error) {
...
func (e *SpotClient) CancelOrder(orderID any) error {
	oid, ok := orderID.(int64)
	if !ok {
...
func (e *SpotClient) CreateOrder(orderReq trade.OrderRequest) (*trade.Order, error) {
...
func (e *SpotClient) GetOrder(orderID any) (*trade.Order, error) {
	oid, ok := orderID.(int64)
	if !ok {
...
func (c *SpotClient) symbol(ctx context.Context, symbol string) (binanceSDK.Symbol, error) {
...
func (c *SpotClient) exchangeInfo(forceUpdate bool) error {
	if !forceUpdate {
